...
Alacritty is a fast terminal & highly customizable terminal built on Rust with a strong, growing community. That's all we need! :D
...
\*In this guide I'll be using the font family "JetBrains Mono". Feel free to download and install any font you would like to use.
...
In order to use the font family we have just installed in Alacritty, you will have to add a few lines to your config.
...
- Then, let's put in use the file we just created:
  ...
  \*In order to give colors to our ASCII art, we put ${c1} to ${c6} at the beginning of the ASCII.
...
Let's open the config once again and make it run Neofetch with a custom ASCII Art location on each start of Alacritty.
...
<div align="center">
  <img src="https://i.imgur.com/DOPtAQq.gif"/>
</div>
